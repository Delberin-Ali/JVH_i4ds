...
with PdfPages('test3.pdf') as pdf:
    ...
    for label, row in df.iterrows():
        ...
        # ax.set_xticklabels(list_dates, rotation = 45)
        im = plt.imshow(final_image.transpose(),cmap = aia.cmap, aspect ="auto", vmin=0) # Please adapt the axes for the correct annotation (y-solar coordinates and x-time)
        plt.colorbar()
